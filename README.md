...
It shows the relationships between `tables` and `bookings`.
...
- WAVE and Lighthouse audits run to identify any major issues, with obvious errors (e.g. missing alt text) corrected where applicable.
